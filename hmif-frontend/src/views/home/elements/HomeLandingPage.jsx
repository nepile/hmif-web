function HomeLandingPage() {
  return (
    <>
      <div className="flex justify-center items-center flex-col lg:py-16 py-44 bg-radial-gradient">
        ...
        <div className="w-[90%] grid flex lg:items-end grid-cols-1 lg:grid-cols-2 gap-10 bg-gray-100 p-10 rounded-sm">
          <div className="mb-5">
