        ...
        <>
            <div className="grid grid-cols-12 gap-5 lg:gap-y-0 gap-y-10 third-bg py-12 px-5 items-start">
                <div className="grid font-thin text-white grid-rows-1 col-span-12 lg:col-span-4 gap-y-5 text-black">
                    ...
                    <div className="w-[80%]">
                        <p>
                            Jl. Paingan, Krodan, Maguwoharjo, Kec. Depok,
                ...
                <div className="grid text-white grid-rows-1 col-span-12 lg:col-span-2 gap-y-5 text-black">
                    ...
                    <div>
                        <div className="flex items-center gap-x-2">
                            ...
                            <a
                                target="blank"
                                href="https://www.instagram.com/hmif.usd/"
                            >
                                Instagram
                            </a>
                        </div>
                        ...
                        <div className="flex items-center gap-x-2">
                            ...
                            <a
                                target="blank"
                                href="https://www.youtube.com/@hmifusd3290"
                            >
                                YouTube
                            </a>
                        </div>
            ...
            <div className="grid grid-rows-2 p-5 bg-gray-900 text-white text-center items-center justify-center">
